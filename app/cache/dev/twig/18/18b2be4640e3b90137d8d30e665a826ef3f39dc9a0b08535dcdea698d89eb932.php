...
\t\t        ";
        // line 94
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "personneAcontacter", array()), 'label', array("label_attr" => array("class" => "control-label"), "label" => "Personne à contacter en cas d'urgence: "));
        echo "
\t\t        <div>
\t\t            ";
        // line 96
...
/* 		<div class="col-md-offset-3 col-sm-offset-1 col-xs-offset-1 col-md-7 col-sm-11 col-xs-11">*/
/* 			<div class="form-group">*/
/* 		        {{ form_label(form.personneAcontacter, 'Personne à contacter en cas d\'urgence: ', {'label_attr': {'class': 'control-label'}}) }}*/
/* 		        <div>*/
