 ...
 */
class Annee extends \School\ConfigBundle\Entity\Annee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'School\\ConfigBundle\\Entity\\Annee' . "\0" . 'id', '' . "\0" . 'School\\ConfigBundle\\Entity\\Annee' . "\0" . 'anneeScolaire');
        }
