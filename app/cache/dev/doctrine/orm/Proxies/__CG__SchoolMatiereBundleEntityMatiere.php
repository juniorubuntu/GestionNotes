...
class Matiere extends \School\MatiereBundle\Entity\Matiere implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'School\\MatiereBundle\\Entity\\Matiere' . "\0" . 'id', '' . "\0" . 'School\\MatiereBundle\\Entity\\Matiere' . "\0" . 'nom', '' . "\0" . 'School\\MatiereBundle\\Entity\\Matiere' . "\0" . 'abreviation', '' . "\0" . 'School\\MatiereBundle\\Entity\\Matiere' . "\0" . 'categorie');
        }
