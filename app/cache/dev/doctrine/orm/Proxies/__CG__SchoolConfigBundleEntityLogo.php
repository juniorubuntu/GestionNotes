...
namespace Proxies\__CG__\School\ConfigBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Logo extends \School\ConfigBundle\Entity\Logo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'School\\ConfigBundle\\Entity\\Logo' . "\0" . 'id', '' . "\0" . 'School\\ConfigBundle\\Entity\\Logo' . "\0" . 'url', '' . "\0" . 'School\\ConfigBundle\\Entity\\Logo' . "\0" . 'alt', '' . "\0" . 'School\\ConfigBundle\\Entity\\Logo' . "\0" . 'file', '' . "\0" . 'School\\ConfigBundle\\Entity\\Logo' . "\0" . 'tempFileName');
        }
