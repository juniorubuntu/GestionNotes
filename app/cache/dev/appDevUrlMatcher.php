        ...
        if (0 === strpos($pathinfo, '/Gestion')) {
            ...
            if (0 === strpos($pathinfo, '/Gestion/evaluation')) {
                ...
                if (preg_match('#^/Gestion/evaluation/(?P<idSequence>[^/]++)/(?P<idMatiere>[^/]++)/(?P<idEnseignant>[^/]++)/statistiques$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'statistiques')), array (  '_controller' => 'School\\NoteBundle\\Controller\\EvaluationController::statistiquesSequenceAction',));
                }

                // notespdf
                if (0 === strpos($pathinfo, '/Gestion/evaluation/enseignement') && preg_match('#^/Gestion/evaluation/enseignement\\-(?P<idEnseignement>[^/]++)/sequence\\-(?P<idSequence>[^/]++)/exportationnotes$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'notespdf')), array (  '_controller' => 'School\\NoteBundle\\Controller\\EvaluationController::exportationNotesAction',));
                }
            ...
            if (0 === strpos($pathinfo, '/Gestion/bulletin')) {
                ...
                // student_performance
                if (0 === strpos($pathinfo, '/Gestion/bulletin/performances/eleve') && preg_match('#^/Gestion/bulletin/performances/eleve\\-(?P<idEleve>\\d+)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'student_performance')), array (  '_controller' => 'School\\NoteBundle\\Controller\\BulletinController::performancesAction',));
                }

                // bulletin_seq_classe
                if (0 === strpos($pathinfo, '/Gestion/bulletin/classe') && preg_match('#^/Gestion/bulletin/classe\\-(?P<idClasse>\\d+)/sequence\\-(?P<idSeq>\\d+)/annee\\-(?P<idAnnee>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'bulletin_seq_classe')), array (  '_controller' => 'School\\NoteBundle\\Controller\\BulletinController::bulletinTestClasseAction',));
                }
            ...
            if (0 === strpos($pathinfo, '/Gestion/cycle')) {
                // cycle
                if (rtrim($pathinfo, '/') === '/Gestion/cycle') {
                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'cycle');
                    }

                    return array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::indexAction',  '_route' => 'cycle',);
                }

                // cycle_show
                if (preg_match('#^/Gestion/cycle/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cycle_show')), array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::showAction',));
                }

                // cycle_new
                if ($pathinfo === '/Gestion/cycle/new') {
                    return array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::newAction',  '_route' => 'cycle_new',);
                }

                // cycle_create
                if ($pathinfo === '/Gestion/cycle/create') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_cycle_create;
                    }

                    return array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::createAction',  '_route' => 'cycle_create',);
                }
                not_cycle_create:

                // cycle_edit
                if (preg_match('#^/Gestion/cycle/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cycle_edit')), array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::editAction',));
                }

                // cycle_update
                if (preg_match('#^/Gestion/cycle/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                        $allow = array_merge($allow, array('POST', 'PUT'));
                        goto not_cycle_update;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cycle_update')), array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::updateAction',));
                }
                not_cycle_update:

                // cycle_delete
                if (preg_match('#^/Gestion/cycle/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                        $allow = array_merge($allow, array('POST', 'DELETE'));
                        goto not_cycle_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cycle_delete')), array (  '_controller' => 'School\\StudentBundle\\Controller\\CycleController::deleteAction',));
                }
                not_cycle_delete:

            }

            if (0 === strpos($pathinfo, '/Gestion/absence')) {
                // absence
                if (rtrim($pathinfo, '/') === '/Gestion/absence') {
                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'absence');
                    }

                    return array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::indexAction',  '_route' => 'absence',);
                }

                // absence_show
                if (preg_match('#^/Gestion/absence/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'absence_show')), array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::showAction',));
                }

                // absence_new
                if ($pathinfo === '/Gestion/absence/new') {
                    return array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::newAction',  '_route' => 'absence_new',);
                }

                // absence_create
                if ($pathinfo === '/Gestion/absence/create') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_absence_create;
                    }

                    return array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::createAction',  '_route' => 'absence_create',);
                }
                not_absence_create:

                // absence_edit
                if (preg_match('#^/Gestion/absence/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'absence_edit')), array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::editAction',));
                }

                // absence_update
                if (preg_match('#^/Gestion/absence/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                        $allow = array_merge($allow, array('POST', 'PUT'));
                        goto not_absence_update;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'absence_update')), array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::updateAction',));
                }
                not_absence_update:

                // absence_delete
                if (preg_match('#^/Gestion/absence/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                        $allow = array_merge($allow, array('POST', 'DELETE'));
                        goto not_absence_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'absence_delete')), array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::deleteAction',));
                }
                not_absence_delete:

                // absence_classe
                if (0 === strpos($pathinfo, '/Gestion/absence/Classe') && preg_match('#^/Gestion/absence/Classe\\-(?P<idClasse>\\d+)/Sequence\\-(?P<idSeq>\\d+)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'absence_classe')), array (  '_controller' => 'School\\StudentBundle\\Controller\\AbsenceController::absenceClasseAction',));
                }
