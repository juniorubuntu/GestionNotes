...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'GestionNotes', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_d443262139b14f9e1ee74fdef706ee43');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d443262139b14f9e1ee74fdef706ee43');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_d443262139b14f9e1ee74fdef706ee43');
        ...
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/School/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/School/StudentBundle/Entity'), 2 => ($this->targetDirs[3].'/src/School/TeacherBundle/Entity'), 3 => ($this->targetDirs[3].'/src/School/MatiereBundle/Entity')));
        ...
        $i->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SchoolUserBundle' => 'School\\UserBundle\\Entity', 'SchoolStudentBundle' => 'School\\StudentBundle\\Entity', 'SchoolTeacherBundle' => 'School\\TeacherBundle\\Entity', 'SchoolMatiereBundle' => 'School\\MatiereBundle\\Entity', 'SchoolNoteBundle' => 'School\\NoteBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('School\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('School\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'School\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webmaster', 'Atemgoua Brumel, juniorubuntu@gmail.com | Sokeing Hydil Aicar shydilaicard@gmail.com');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.model.user.class' => 'School\\UserBundle\\Entity\\User',
