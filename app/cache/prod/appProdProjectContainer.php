...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'Shopping', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_986fcef89bc896b019ea0cd3b5a14f9c');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_986fcef89bc896b019ea0cd3b5a14f9c');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_986fcef89bc896b019ea0cd3b5a14f9c');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Shopping/ShopBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Shopping/UserBundle/Entity')));
        ...
        $g->addDriver($e, 'Shopping\\ShopBundle\\Entity');
        $g->addDriver($e, 'Shopping\\UserBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('ShoppingShopBundle' => 'Shopping\\ShopBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'ShoppingUserBundle' => 'Shopping\\UserBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'a88535fb64110b17b725af1364ee4a3e');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Shopping\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Shopping\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Shopping\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Shop/Administration');
        ...
        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => true, 'default_target_path' => '/Shop', 'use_referer' => true, 'target_path_parameter' => '_target_path'));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Shopping/ShopBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Shopping/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webmaster', 'Atemgoua Brumel, juniorubuntu@gmail.com');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Shopping/ShopBundle/Resources/views'), 'ShoppingShop');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Shopping/UserBundle/Resources/views'), 'ShoppingUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a88535fb64110b17b725af1364ee4a3e');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ShoppingShopBundle' => 'Shopping\\ShopBundle\\ShoppingShopBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'ShoppingUserBundle' => 'Shopping\\UserBundle\\ShoppingUserBundle',
            ),
            ...
            'locale' => 'fr',
            'secret' => 'a88535fb64110b17b725af1364ee4a3e',
            ...
            'kernel.secret' => 'a88535fb64110b17b725af1364ee4a3e',
            ...
            'fos_user.model.user.class' => 'Shopping\\UserBundle\\Entity\\User',
