...
use School\NoteBundle\Form\SequenceType;
...
class SequenceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SchoolNoteBundle:Sequence')->findAll();
     ...
     * @Method("POST")
     * @Template("SchoolNoteBundle:Sequence:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SchoolNoteBundle:Sequence')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SchoolNoteBundle:Sequence:edit.html.twig")
     */
