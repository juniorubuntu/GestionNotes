...
use School\MatiereBundle\Form\CategorieType;
...
class CategorieController extends Controller{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SchoolMatiereBundle:Categorie')->findAll();

        return $this->render('SchoolMatiereBundle:Categorie:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
...
//        $form->add('submit', 'submit', array('label' => 'Create'));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SchoolMatiereBundle:Categorie')->find($id);
        ...
        return $this->render('SchoolMatiereBundle:Categorie:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SchoolMatiereBundle:Categorie:edit.html.twig', array(
            'entity'      => $entity,
